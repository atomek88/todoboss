...
import 'package:flutter/material.dart' show Slider, Material, MaterialType, MaterialApp, Scaffold, ScaffoldMessenger;
...
import 'package:todoApp/feature/todos/providers/task_goal_provider.dart';
...
class ProfilePage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MaterialApp(
      // Wrap with MaterialApp to provide ScaffoldMessenger
      debugShowCheckedModeBanner: false,
      home: CupertinoPageScaffold(
      navigationBar: const CupertinoNavigationBar(middle: Text('Profile')),
      child: Material(
        // Add Material widget as ancestor for Slider
        type: MaterialType.transparency, // Make it transparent to keep Cupertino look
        child: SafeArea(
          child: Padding(
                  ...
                  children: [
                    Consumer(
                      builder: (context, ref, child) {
                        final taskGoal = ref.watch(taskGoalProvider);
                        return Row(
                    ...
                    Consumer(
                      builder: (context, ref, child) {
                        ...
                        return Slider(
                          ...
                          onChanged: (value) {
                            ref.read(taskGoalProvider.notifier).updateTaskGoal(value.toInt());
                          },
                        );
                      },
                    ),
