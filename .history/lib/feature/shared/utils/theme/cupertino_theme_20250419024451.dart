...
CupertinoThemeData lightCupertinoTheme() {
  return const CupertinoThemeData(
    ...
    barBackgroundColor: Color.fromARGB(255, 42, 130, 212), // Using your surface color
    scaffoldBackgroundColor: Color.fromARGB(255, 42, 130, 212), // Using your background color
