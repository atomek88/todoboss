...
extension DailySummaryExtension on DailySummary {
  ...
  double get completionRate => todoGoal > 0 ? todoCompletedCount / todoGoal : 
                              todoCompletedCount > 0 ? 1.0 : 0.0;
  
  bool get goalAchieved => todoGoal > 0 && todoCompletedCount >= todoGoal;
  
  double get deletionRate => todoCreatedCount > 0 ? todoDeletedCount / todoCreatedCount : 0.0;
