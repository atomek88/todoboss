...
import 'package:todoApp/feature/daily_todos/services/daily_todo_filter_service.dart';
                          ...
                          child: SwipeableDatePicker(
                            ...
                            onDateSelected: (date) {
                              ...
                              ref
                                  ...
                                  .dateChanged(date);
                              debugPrint(
                                  '🔄 [TodosHomePage] Date selected via picker: $date');
                            },
                            onPastDateTap: (date) {
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8.0),
                        _buildSummaryRow(context, 'Goal',
                            '${dailyTodo.taskGoal}', Icons.flag_outlined),
                      ],
                    ),
                  ),
