...
class TodoInteractiveCard extends ConsumerWidget {
  ...
  final _expandedTodoItemsProvider = StateProvider.family<bool, String>((ref, todoId) => false);
      ...
      child: Card(
        ...
        child: Column(
          ...
          children: [
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (todo.scheduled != null && todo.scheduled! > 0)
                            Padding(
                              padding: const EdgeInsets.only(top: 4.0),
                              child: Row(
                                children: [
            ...
            if (todo.hasSubtasks && ref.watch(_expandedTodoItemsProvider(todo.id)))
              Padding(
