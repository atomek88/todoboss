...
import '../../../feature/daily_todos/providers/daily_todos_provider.dart';
...
class _TodoSubtaskSectionState extends ConsumerState<TodoSubtaskSection> {
  ...
  void _addSubtask() {
    ...
    if (!currentDate.isAtSameMomentAs(selectedDate)) {
      talker.debug('📌 [TodoSubtaskSection] Dates don\'t match, refreshing both dates');
      ref
          .read(dailyTodoProvider.notifier)
              ...
              return Padding(
                ...
                child: SwipeableItem(
                  ...
                  onDelete: () {
                    ...
                    talker.debug('📌 [TodoSubtaskSection] Deleting subtask - Current date: $currentDate');
                    talker.debug('📌 [TodoSubtaskSection] Deleting subtask - Selected date: $selectedDate');
                          ...
                          Transform.scale(
                            ...
                            child: Checkbox(
                              ...
                              onChanged: (value) {
                                ...
                                talker.debug('📌 [TodoSubtaskSection] Toggling completion - Current date: $currentDate');
                                talker.debug('📌 [TodoSubtaskSection] Toggling completion - Selected date: $selectedDate');
