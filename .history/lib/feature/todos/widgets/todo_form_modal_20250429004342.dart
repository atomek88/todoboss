...
import '../../../shared/animations/animated_button.dart';
                      ...
                      Row(
                        ...
                        children: [
                            ...
                            child: AnimatedButton(
                              onPressed: () {
                                Navigator.of(context)
                                    .pop(); // Cancel and close modal
                              },
                              backgroundColor:
                                  const Color(0xFFD3D3D3), // Soft metallic gray
                          ...
                          Expanded(
                            child: AnimatedButton(
                              onPressed: () {
                                _saveChanges(); // Make sure everything is saved

                                // For new todos, create a new todo if form values exist
                                if (widget.todo == null) {
                                  final formValues =
                                      ref.read(todoFormValuesProvider);
                                  if (formValues['title']?.isNotEmpty ??
                                      false) {
                                    final TodoType type =
                                        formValues['type'] as TodoType? ??
                                            TodoType.default_todo;
                                    ...
                                    ref
                                        ...
                                        .addTodo(newTodo);
                                    talker.debug(
                                        '[TodoFormModal] Created new todo: ${newTodo.title}');
                                  }
                                }
                              ...
                              backgroundColor: const Color(
                                  0xFFB8860B), // Warm metallic gold/bronze
            ...
            child: Center(
              child: Text(
                isEditing
                    ...
                    : 'Use the Save button to create your task',
...
void showTodoFormModal(BuildContext context,
  ...
  // We removed the auto-save on dismiss functionality to prevent double saves
}
