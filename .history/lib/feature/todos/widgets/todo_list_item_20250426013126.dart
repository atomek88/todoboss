                                  ...
                                  child: InkWell(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Stack(
                                        ...
                                        children: [
                                          // Use ColorFiltered to make the icon brighter when expanded
                                          ColorFiltered(
                                            colorFilter: ColorFilter.mode(
                                              ref.watch(
                                                      _expandedTodoItemsProvider(
                                                          todo.id))
                                                  ? Colors.blue
                                                      .shade300 // Brighter when expanded
                                                  : Colors.grey
                                                      .shade400, // Normal color when collapsed
                                              BlendMode.srcATop,
                                            ),
                                            child: Image.asset(
                                          ...
                                          // Indicator dot for subtasks without blue outline
                                          if (todo.hasSubtasks &&
                                              !ref.watch(
                                                  _expandedTodoItemsProvider(
                                                      todo.id)))
