            ...
            child: ListView(
              ...
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('Repeat on', style: TextStyle(fontSize: 14, color: Colors.black54)),
                    const SizedBox(height: 8),
                    Row(
                      ...
                      children: List.generate(7, (index) {
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            height: 36,
                            decoration: BoxDecoration(
                              color: selectedDays[index] ? Colors.blue : Colors.grey.shade200,
            ...
            children: [
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Recurring task added')),
                  );
