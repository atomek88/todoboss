...
class _TodoFormModalState extends ConsumerState<TodoFormModal> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(todoRolloverProvider.notifier).state = widget.todo?.rollover ?? false;
    });
  }
              ...
              SquareAppIcon(
                ...
                onStateChanged: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('Rollover ${isActivated ? 'enabled' : 'disabled'}'),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    ref.watch(todoRolloverProvider) ? 'Enabled' : 'Disabled',
                    style: TextStyle(
                      color: ref.watch(todoRolloverProvider) ? Colors.green : Colors.red,
                    ),
                  ),
                  const Spacer(),
                  const Text(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  ...
                  if (isEditing) {
                    ref.read(todoListProvider.notifier).updateTodo(todo.id, todo);
                  } else {
