...
class TaskGoalNotifier extends StateNotifier<int> {
  static const String _prefKey = 'task_goal';
  static const String _hiveBoxName = 'settings_box';
  static const String _hiveKey = 'task_goal';
  static const int _defaultGoal = 20;
  
  final StorageService _storageService;
  
  TaskGoalNotifier(this._storageService) : super(_defaultGoal) {
    _loadGoal();
  }
  ...
  Future<void> _loadGoal() async {
    ...
    if (jsonString != null) {
      try {
        ...
        print('Error parsing task goal: $e');
      }
    }
  }
