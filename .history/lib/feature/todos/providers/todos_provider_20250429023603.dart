  ...
  void deleteTodo(String id) async {
    try {
      ...
      if (todoIndex != -1) {
        ...
        final dailyTodo = await todoDateRepo.getDailyTodoForDate(deletionDate);
        ...
        await todoDateRepo.saveDailyTodo(updatedDailyTodo);
  ...
  void restoreTodo(String id) async {
    try {
      ...
      if (todoIndex != -1) {
        ...
        _ref.read(todoDateProvider.notifier).forceReload();
