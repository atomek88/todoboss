  ...
  Future<DailyTodo?> addTodoToDate(DateTime date, String todoId) async {
    try {
      ...
      if (!dailyTodo.todos.contains(todo)) {
        ...
        debugPrint(
            '📅 [DailyTodoRepository] Added todo $todoId to date ${dailyTodo.id}');
        return updatedDailyTodo;
      } else {
        debugPrint(
            '📅 [DailyTodoRepository] Todo $todoId already on date ${dailyTodo.id}');
        return dailyTodo;
      }
    } catch (e) {
  ...
  Future<DailyTodo?> removeTodoFromDate(DateTime date, String todoId) async {
    try {
      ...
      if (dailyTodo.todos.contains(todo)) {
        ...
        debugPrint(
            '📅 [DailyTodoRepository] Removed todo $todoId from date ${dailyTodo.id}');
        return updatedDailyTodo;
      } else {
        debugPrint(
            '📅 [DailyTodoRepository] Todo $todoId not on date ${dailyTodo.id}');
        return dailyTodo;
      }
    } catch (e) {
