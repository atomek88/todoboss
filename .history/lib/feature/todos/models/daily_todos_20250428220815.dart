...
class DailyTodos {
  ...
  factory DailyTodos.fromDate(DateTime date, {int taskGoal = 0}) {
  ...
  factory DailyTodos.fromJson(Map<String, dynamic> json) {
    return DailyTodos(
