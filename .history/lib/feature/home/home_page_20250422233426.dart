...
import 'package:todoApp/shared/widgets/recurring_app_icon.dart';
import 'package:todoApp/shared/utils/styles/app_color.dart';
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              TextButton(
                  onPressed: () =>
                      context.router.push(const AnimationsShowcase()),
