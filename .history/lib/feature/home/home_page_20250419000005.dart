            ...
            children: <Widget>[
              TextButton(
                  onPressed: () => context.router
                      .push(UsersWrapperRoute(title: 'Search Users Example')),
                  child: const Text('Search users Example')),
              const Divider(),
              TextButton(
                  onPressed: () => context.router
                      .push(CounterWrapperRoute(title: 'Counter Example')),
                  child: const Text('Counter Example')),
              const Divider(),
              TextButton(
                  onPressed: () => context.router
                      .push(Counter2WrapperRoute(title: 'Counter2 Example')),
...
const IOSHomePage({
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _IOSHomePageState();
