      ...
      child: SafeArea(
        child: Center(
          child: Column(
            ...
            children: [
              CupertinoButton(
                onPressed: () => context.router.push(const UsersWrapperRoute()),
                child: const Text('Go to Users'),
              ),
              CupertinoButton(
                onPressed: () => context.router.push(Counter2WrapperRoute()),
                child: const Text('Go to Counter2'),
              ),
              CupertinoButton(
                onPressed: () => context.router.push(const TodosWrapperRoute()),
