...
class DailySummaryDetail extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          ...
          _buildProgressSection(
            ...
            summary.todoGoal > 0 ? summary.todoGoal : summary.todoCompletedCount + summary.todoDeletedCount,
            completedColor,
          ),
          ...
          if (summary.todoGoal > 0)
            _buildGoalAchievementIndicator(),
        ],
      ),
    );
  }
  ...
  Widget _buildProgressSection(String title, int completed, int total, Color color) {
  ...
  Widget _buildGoalAchievementIndicator() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: achieved ? Colors.green.withOpacity(0.1) : Colors.amber.withOpacity(0.1),
        borderRadius: BorderRadius.circular(8),
        border: Border.all(
