...
/// Provider to track the activation state of the icons
final rockIconActivatedProvider = StateProvider<bool>((ref) => false);
final slinkyIconActivatedProvider = StateProvider<bool>((ref) => false);
...
class SquareAppIcon extends ConsumerWidget {
  ...
  final StateProvider<bool> activationProvider;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        ref.read(activationProvider.notifier).state = !isActivated;
